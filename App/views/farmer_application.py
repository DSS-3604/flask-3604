...
def approve_farmer_application_action(id):
    ...
    if approve_farmer_application(id):
        create_log(
            current_identity.id, "Farmer Application approved", f"Farmer Application {f_application.id} approved"
        )
...
def reject_farmer_application_action(id):
    ...
    if reject_farmer_application(id):
        create_log(
            current_identity.id, "Farmer Application rejected", f"Farmer Application {f_application.id} rejected"
        )
